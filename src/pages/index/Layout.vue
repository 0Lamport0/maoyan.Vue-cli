<template>
  <div class="index-wrap">
    ...
    <nav class="topbar">
      <div class="city-entry" @click="cityHandleClick">
        <span>北京</span>
        <i class="yo-ico">&#xf033;</i>
      </div>
      <div class="swich-hot">
    ...
    <footer>
      <ul>
        ...
        <router-link tag="li" to="/index/theaters" active-class="active">
    ...
    <!-- <van-tabbar v-model="active" route active-color="#e54748">
      <van-tabbar-item replace to="/index/movies">
        <span>电影</span>
...
Vue.use(Tabbar).use(TabbarItem).use(Sticky);
